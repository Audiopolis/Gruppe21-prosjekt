...
Public NotInheritable Class TestCalendar
    Inherits Control
    ...
    Private NotInheritable Class WeekHeader
        ...
        Private ParentContainer As TestCalendar
        Private H As Integer
        Private ColWidth As Integer
        Public Property Parent As TestCalendar
            Get
                Return ParentContainer
            End Get
            Set(value As TestCalendar)
        ...
        Public Sub SetDayNames()
            ...
            Next
        End Sub
        Public Sub New(Parent As TestCalendar, Left As Integer, Top As Integer, Spacing As Integer, Optional Width As Integer = 100, Optional ByVal Height As Integer = 100)
            ColWidth = Width
            H = Height
            For i As Integer = 0 To 6
                WeekDays(i).Hide()
...
#Region "Fields"
        ...
        Private ParentControl As TestCalendar
...
#End Region
        ...
        Public Property MonthString As String
            ...
            End Set
        End Property
        Public Sub New(Parent As TestCalendar, ByVal Left As Integer, ByVal Top As Integer, ByVal Width As Integer, ByVal Height As Integer)
...
#End Region
    ...
    Public NotInheritable Class CalendarDay
        ...
        Public Shadows Property Parent As TestCalendar
            Get
                Return DirectCast(MyBase.Parent, TestCalendar)
            End Get
            Set(Parent As TestCalendar)
